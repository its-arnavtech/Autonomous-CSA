...
declare global {
  var __AUTONOMOUS_WORKER_METRICS__: MetricsState | undefined;
}
...
function getOrCreateMetricsState(): MetricsState {
  if (globalThis.__AUTONOMOUS_WORKER_METRICS__) {
    return globalThis.__AUTONOMOUS_WORKER_METRICS__;
  }

  const registry = new Registry();
  collectDefaultMetrics({
    register: registry,
    prefix: 'autonomous_worker_',
  });
  ...
  globalThis.__AUTONOMOUS_WORKER_METRICS__ = state;
  return state;
}
...
export class MetricsService {
  ...
  static resetForTests() {
    globalThis.__AUTONOMOUS_WORKER_METRICS__?.registry.clear();
    globalThis.__AUTONOMOUS_WORKER_METRICS__ = undefined;
  }
